...
LOCKSCREENIMG='/home/rasendorf/.config/awesome/themes/default/lockscreen.png'
...
exec xautolock -detectsleep -time 10 -locker "i3lock -t -i $LOCKSCREENIMG" -notify 30 -notifier "notify-send -u critical -t 10000 -- 'LOCKING screen in 30 seconds'"
